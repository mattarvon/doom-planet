...
const MOCK=[
  {id:1,name:"Mary Lee",species:WS,gender:"female",stageOfLife:"Mature",length:"16ft (4.9 m)",weight:"3456 lbs.",tagDate:"17 Sep 2012",tagLocation:"Cape Cod, MA",pings:track(11,-67.5,40.2,14,2.2,1.5, 0.5,0.16),
    bio:"Den mother of this crew of degenerates and the only one with a body count in four digits. Mary Lee bit the dick clean off a best man skinny-dipping at his own bachelor party — didn't eat it, just kept it, the way some people keep a bowling trophy. She confiscates the pod's weed every Friday and smokes all of it herself by Saturday. The Coast Guard keeps a group chat about her. She's in it. Under a fake name. Talking shit."},
  {id:2,name:"Katharine",species:WS,gender:"female",stageOfLife:"Sub-adult",length:"14ft 2in (4.3 m)",weight:"2300 lbs.",tagLocation:"Cape Cod, MA",tagDate:"02 Aug 2013",pings:track(23,-73.5,33.5,14,2.0,1.6, 0.42,-0.42),
    bio:"The teenage menace. Katharine invented the sorority panty raid, shark edition: hits the Delta Gamma beach bonfire at 2 a.m., surfaces through the shallows like a submarine full of bad decisions, and swims off wearing eleven bikini tops on her dorsal fin like a trophy rack. Banned from six beaches, two spring breaks, and one aquarium gift shop (unrelated incident, still not sorry). Scientists tagged her 'for research.' She treats the tracker like a body-count leaderboard and she is disgustingly, historically winning."},
  {id:3,name:"Lydia",species:WS,gender:"female",stageOfLife:"Mature",length:"14ft 6in (4.4 m)",weight:"2000 lbs.",tagLocation:"Jacksonville, FL",tagDate:"02 Mar 2013",pings:track(37,-58,39.5,16,2.4,1.4, 0.62,-0.08),
    bio:"First white shark documented crossing the entire Atlantic — not to migrate, to PARTY. Lydia did Ibiza in one night: ate a stag party off a catamaran, did a bong rip out of a sunken amphora ('vintage piece, hits clean'), and mooned a ferry, which for a shark takes real commitment. She rates every nation's swimmers like a Yelp reviewer with a substance problem and will share the rankings unprompted, mid-chew. Spain is winning. Spain doesn't want to know why."},
  {id:4,name:"Contender",species:WS,gender:"male",stageOfLife:"Mature",length:"13ft 9in (4.2 m)",weight:"1653 lbs.",tagLocation:"FL-GA line",tagDate:"17 Jan 2025",pings:track(51,-76,30.5,13,2.0,1.5, 0.5,0.34),
    bio:"The meathead. Contender fights boats for fun and is undefeated. He chomped a skinny-dipper's dick off at a lake party, spat it at the guy's best friend, and the police report — filed against a fish — was dismissed, because you cannot subpoena a nightmare. Does 'security' for the pod's parties, which means eating the gatecrashers and at least one invited guest ('he was being a dick.' Contender, that's YOUR thing). Surfaces to make eye contact first. A courtesy."},
  {id:5,name:"Breton",species:WS,gender:"male",stageOfLife:"Mature",length:"13ft 3in (4.0 m)",weight:"1437 lbs.",tagLocation:"Scatarie Island, NS",tagDate:"12 Sep 2020",pings:track(67,-57,43.5,14,2.2,1.6, 0.5,-0.18),
    bio:"The pod's dealer and Canada's most polite felon. Breton grows a proprietary strain of kelp in a shipwreck off Nova Scotia ('Scotian Shelf Kush') and runs the Friday sesh where the whole crew hotboxes a sunken school bus. Apologizes to each seal individually right before — 'sorry aboot this, bud' — and once returned a stolen bikini top from one of Katharine's raids with a handwritten note. Then ate the mailman. Thirteen feet of sorry and zero percent of it meant."},
  {id:6,name:"Nukumi",species:WS,gender:"female",stageOfLife:"Mature",length:"17ft 2in (5.2 m)",weight:"3541 lbs.",tagLocation:"Lunenburg, NS",tagDate:"02 Oct 2020",pings:track(83,-51,42.5,13,2.4,1.5, 0.55,-0.12),
    bio:"The grandmother, and worse than all of them combined. Seventeen feet, half a ton, out-smokes the entire pod off a shipwreck's smokestack like it's a two-story bong and calls it 'her medicine.' Nukumi crashed a yacht-club regatta in '09, ate the commodore, wore his captain's hat for a week, and nobody said one goddamn word. She has seen things science hasn't named and eaten most of them. When she surfaces, the tide leaves early — it knows."},
  {id:7,name:"Maple",species:TG,gender:"female",stageOfLife:"Sub-adult",length:"10ft 7in (3.2 m)",weight:"616 lbs.",tagLocation:"Bermuda",tagDate:"21 Jun 2023",pings:track(97,-64.7,31.5,12,1.9,1.8, 0.12,0.18),
    bio:"Tiger sharks eat everything; Maple took that as a dare and a lifestyle. Confirmed stomach contents: a license plate, patio furniture, one (1) very unlucky drone, Breton's entire stash, THE BONG, and the guy holding the bong. She crashed a booze cruise in Bermuda, ate the DJ booth mid-drop, and the crowd cheered because honestly the set was mid. Bermuda put up a Maple-shaped warning sign. She ate it. Then the sign about the sign. She will eat this bio."},
  {id:8,name:"Khaleesi",species:WS,gender:"female",stageOfLife:"Sub-adult",length:"9ft 4in (2.8 m)",weight:"460 lbs.",tagLocation:"Gansbaai, ZA",tagDate:"15 May 2022",pings:track(110,21.5,-36.5,12,2.0,1.5, 0.34,-0.16),
    bio:"The drama major. Khaleesi breaches twelve feet purely for the gasp — and once, at a nude beach volleyball game, caught the ball AND the server in the same jump, which the survivors described as 'honestly kind of impressive.' She hits Katharine's panty raids strictly for the theatrics: three backflips, zero panties, all attitude. If sharks could talk she'd have a villain monologue, a wind machine, and a restraining order from at least two yacht clubs. Instead she just does the thing. With the teeth. Slowly. For the applause."},
  {id:9,name:"Bronson",species:WS,gender:"male",stageOfLife:"Mature",length:"12ft 9in (3.9 m)",weight:"1326 lbs.",tagLocation:"Neptune Is, AU",tagDate:"08 Dec 2021",pings:track(126,135.5,-37.5,11,1.9,1.4, 0.28,-0.16),
    bio:"The quiet one, which in this crew makes him the scariest dickhead of all. Bronson bounces the pod's parties: no chasing, no drama — he just squints, and grown men climb out of the ocean on water. He ended an entire Australian booze cruise by surfacing next to it and doing nothing. Holds the pod record for surfboards launched into low orbit (14) and dicks bitten off with zero follow-through ('wasn't hungry, was making a point'). Everyone comes to Bronson eventually. Everyone."},
  {id:10,name:"Riptide",species:MK,gender:"male",stageOfLife:"Mature",length:"8ft 1in (2.5 m)",weight:"298 lbs.",tagLocation:"Montauk, NY",tagDate:"30 Jul 2024",pings:track(140,-69.5,38.8,15,2.4,1.7, 0.52,-0.34),
    bio:"The 45-mph gremlin who plans the panty raids, takes none of the blame, and cannot physically shut up. Riptide has stolen a GoPro (posted the footage), a six-pack (shotgunned two cans, fins, somehow), and the entire anchor line of a honeymoon charter, purely to watch it drift. Bit a propeller off to hear the noise. Did it again because the first noise 'slapped.' Montauk fishermen don't tell Riptide stories at the bar — Riptide tells fisherman stories, and they're all very short, and he does the voices."},
];
